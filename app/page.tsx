  ...
  return <div className="storefront">{showAuth&&<AuthModal reason={authReason} onClose={()=>setShowAuth(false)}/>} {panel&&user&&<StorePanels kind={panel} user={user} onClose={()=>setPanel(null)} onChanged={reloadCounts}/>} {notice&&<div className="toast">{notice}</div>}
    ...
    <header className="site-header">
      ...
      <nav className="nav wrap">
        ...
        <a className={navSection==="deals"?"active":""} onClick={()=>setNavSection("deals")} href="#deals">Today&apos;s deals</a><a className={navSection==="categories"?"active":""} onClick={()=>setNavSection("categories")} href="#categories">Categories</a><a className={navSection==="new"?"active":""} onClick={()=>setNavSection("new")} href="#new">New arrivals</a><a className={navSection==="popular"?"active":""} onClick={()=>setNavSection("popular")} href="#popular">Most wanted</a>
